                    ...
                    <ul className='lh-lg'>
                        ...
                        <li>
                            <NavDropdown
                                ...
                                title={
                                    <span
                                        className="overlay-content-itema text-white text-inter py-2 font-24 me-3 d-flex all-side-icons align-items-center">about us</span>
                                }
                        ...
                        <li>
                            <Link href="/termsAndcondition/TermsAndConditions" onClick={closeSearch}
                                  className='overlay-content-itema'>terms & conditons</Link>
                        </li>
                        <li>
                            <Link href="/privacypolicy/PrivacyPolicy" onClick={closeSearch}
                                  className='overlay-content-itema'>privacy policy</Link>
                        </li>
                        <li>
                            <Link href="/deliveryinformation/DeliveryInformation" onClick={closeSearch}
                                  className='overlay-content-itema'>delivery</Link>
                        </li>
                        <li>
                            <Link href="/contactinformation/ContactInformation" onClick={closeSearch}
