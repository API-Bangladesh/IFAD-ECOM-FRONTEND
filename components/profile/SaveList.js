...
const SaveList = () => {
	...
	const fetchData = async () => {
		...
		try {
			await axios.get(`${BACKEND_URL}/wishlist`, {headers})
				.then((res) => {
									...
									<div className="card-border mb-4">
										<div className="">
											<Link href="/singleproduct/SingleProduct" className="">
												<Image src="https://i.postimg.cc/hjwzF1cM/product1.png" alt=""
													   className="img-fluid product-img mt-3 pb-3 mx-auto d-block"/>
											</Link>
										</div>
										...
										<div className="d-flex justify-content-center mb-3">
											...
											>
												<div
													className="d-flex justify-content-between text-center font-14 pe-0">
											...
											<div className="d-flex justify-content-center mb-3">
												...
												>
													<div
														...
														<AiOutlineShoppingCart className="pt-1 pe-1" size={"20px"}/>
														<span
															className="fw-normal font-lato ad-card-btn">add to cart</span>
													</div>
												</button>
											</div>
										</div>
